                ...
                <ContentTemplate>
                    ...
                    <div style="width: 100%" class="pagePannelHeader">
                        <asp:GridView ID="gvVoterMaster" CssClass="mGrid" runat="server" OnSorting="gvVoterMaster_Sorting" AllowSorting="true" ShowHeader="true" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false" EmptyDataText="No record found." Width="100%" Enabled='<%# this.IsVoterSubmit.ToString().ToUpper() == "True".ToUpper() && this.UserTypeName.ToUpper() == EnumUserType.voter.ToUpper()  ? false : true %>'>
                            <Columns>
                                <asp:TemplateField HeaderText="Broker/Firm Name" HeaderStyle-CssClass="gvActionHeadertxtAlign" SortExpression="BrokerName" HeaderStyle-Width="20%">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Broker Analyst" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="gvActionHeadertxtAlign" HeaderStyle-Width="10%" SortExpression="AnalystName">
                                    <ItemTemplate>
                                 ...
                                 <%-- anshu change on 12/05/2023 --%>
                                            <asp:TemplateField HeaderStyle-CssClass="gvActionHeadertxtAlign" HeaderStyle-Width="40%" HeaderText="Voter Comment" ItemStyle-HorizontalAlign="Center" SortExpression="RMComment">
                                                <ItemTemplate>
                                                     <span id="Span6" runat="server" visible='<%#(this.RoleTypeName.ToUpper()==EnumRolType.RA) %>'><%--this.DepartmentName.ToUpper()!=EnumDeptType.DOFA--%>
                                                    <asp:TextBox ID="commentid" runat="server" CssClass="gvActionHeadertxtAlign" Style="margin: 0px !important;" Text='<%# Eval("RMComment").ToString() %>' Width="97%"></asp:TextBox>
                                                    </span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <%-- end --%>

                                <asp:TemplateField HeaderText="Sector Name" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="gvActionHeadertxtAlign" HeaderStyle-Width="10%" SortExpression="SectorName">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Vote" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="gvActionHeadertxtAlign" HeaderStyle-Width="12%" SortExpression="Vote">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtGridVote" runat="server" Style="margin: 0px !important;" Text='<%# !string.IsNullOrEmpty(Eval("Vote").ToString()) ? Convert.ToDecimal(Eval("Vote")).ToString("f") : "0.00" %>' MaxLength="5" BackColor="White" CssClass="gvActionHeadertxtAlign" Width="90%" AutoPostBack="true" OnTextChanged="txtGridVote_TextChanged" ></asp:TextBox><%--OnTextChanged="txtGridVote_TextChanged"--%>
